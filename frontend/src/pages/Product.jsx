...
const Product = () => {
  ...
  {/* Heart Bubble Background */}
  <div className="bubbles"></div>

  <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100 relative z-10">
    {/* Product Data */}
  ...
  className="relative overflow-hidden bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-3 text-sm rounded-lg shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95 focus:outline-none"
>
  <span className="relative z-10">ADD TO CART</span>

  {/* Circulating Border */}
  <span className="absolute inset-0 rounded-lg border-2 border-transparent before:absolute before:inset-0 before:rounded-lg before:border-2 before:border-transparent before:border-gradient-to-r from-purple-500 to-blue-500 before:animate-spin-slow"></span>
</button>
  ...
  <style jsx>{`
    ...
    .bubbles::after {
      ...
      width: 100%;
      height: 100%;
      background: radial-gradient(circle at 50% 50%, #ff66a3, transparent 70%);
